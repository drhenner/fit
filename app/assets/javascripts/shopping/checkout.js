...
if (typeof UfcFit.Shopping == "undefined") {
    UfcFit.Shopping = {};
}
var debug_variable = null;
// If we already have the Cart object don't override
if (typeof UfcFit.Shopping.cart == "undefined") {

    UfcFit.Shopping.cart = {
        initialize      : function( ) {
          ...
          $("#purchase_cart_order").submit(function(event) {
            ...
            UfcFit.Shopping.cart.submitForm();
        ...
        submitForm : function () {
              ...
              success: function(jsonText){
                ...
                if ( jsonText.order.integer_credited_total == UfcFit.Shopping.cart.orderAmount()) {
                  Stripe.createToken({
                      ...
                      exp_month:  $('#month').val(),
                      exp_year:   $('#year').val()
                  }, UfcFit.Shopping.cart.stripeResponseHandler);
                } else {
          ...
          } else if(UfcFit.Shopping.cart.useCardOnFile()) {
            //
            UfcFit.Shopping.cart.chargeCardOnFile();
          } else {
    ...
    // Start it up
    jQuery(function() {
      UfcFit.Shopping.cart.initialize();
    });
}
