...
if (typeof UfcFit.AdminShopping == "undefined") {
    UfcFit.AdminShopping = {};
}
var debug_variable = null;
// If we already have the Cart object don't override
if (typeof UfcFit.AdminShopping.cart == "undefined") {

    UfcFit.AdminShopping.cart = {
        initialize      : function( ) {
          ...
          $("#purchase_admin_order").submit(function(event) {
            ...
            UfcFit.AdminShopping.cart.submitForm();
          ...
          $('#use-card-on-file-button').click(function(){
            ...
            if (paymentProfileId > 0){
              UfcFit.AdminShopping.cart.submitPaymentProfileForm();
              return false;
            } else {
        ...
        submitForm : function () {
              ...
              success: function(jsonText){
                ...
                if ( jsonText.order.integer_credited_total == UfcFit.AdminShopping.cart.orderAmount()) {
                  Stripe.createToken({
                      ...
                      exp_month:  $('#month').val(),
                      exp_year:   $('#year').val()
                  }, UfcFit.AdminShopping.cart.stripeResponseHandler);
                } else {
          ...
          } else if(UfcFit.AdminShopping.cart.useCardOnFile()) {
            //
            UfcFit.AdminShopping.cart.chargeCardOnFile();
          } else {
        ...
        chargeCardOnFile : function(){
          UfcFit.App.helpers.startWaitScreen();
          jQuery.ajax({
            type : "PUT",
            ...
            success: function(jsonText){
              ...
              if (jsonText.order.errors) {
                ...
                $(".payment-errors").fadeIn();
                UfcFit.App.helpers.stopWaitScreen();
              } else {
    ...
    // Start it up
    jQuery(function() {
      UfcFit.AdminShopping.cart.initialize();
    });
}
